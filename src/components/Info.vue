...
import { NCard, NAlert, NSpace, NCollapse, NCollapseItem, NList, NListItem, NThing, NTable } from 'naive-ui';
</script>
<template>
    <n-space vertical>
        <n-alert title="技术测试版本警告" type="warning">当前版本属于非常早期的技术测试版本，可能存在很多问题，请谨慎在生产环境使用。<br />若遇到问题，请及时联系我们。</n-alert>
            ...
            <n-collapse>
                <n-collapse-item title="使用的开源组件 (NPM)" name="1">
                    <n-list hoverable>
                        ...
                        <n-list-item>
                            <n-thing title="typescript@~5.6.2" description="https://github.com/microsoft/TypeScript"/>
                        </n-list-item>
                        <n-list-item>
